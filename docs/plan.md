...
- [x] GitHub Actions ワークフロー (main push → GitHub Pages)
...
- [x] `/spec-update home-page`
- [x] `/spec-do home-page`      ← feat/phase-2-home-page ブランチ
- [x] `/spec-update series-page` ← Series コレクション追加・series-nav・タイトル差し替えを含む
- [x] `/spec-do series-page`    ← feat/phase-2-series-page ブランチ (series-nav・タイトル差し替えも同ブランチ)
- [x] `/spec-update posts-page` ← home-page の "すべての記事を見る" リンク先。/posts 一覧ページ
- [x] `/spec-do posts-page`     ← feat/phase-2-posts-page ブランチ

### Phase 3: インタラクティブ機能

- [x] `/spec-update hover-preview` — 仕様作成完了
- [x] `/spec-do hover-preview` — hover preview React island + MathJax 再実行
- [x] `/spec-update search` — Pagefind 統合・prefix filter・def-page body 絞り込み仕様
- [x] `/spec-do search` — Pagefind 統合
